    ...
    <Container>
      <div className="flex flex-col justify-center items-start max-w-2xl border-gray-200 dark:border-gray-700 mx-auto pb-16">
        ...
        <div className="flex gap-6 flex-col w-full">
          <BlogPostCard
            title="Using nvm to manage nodejs versions across projects"
          ...
          />
          <BlogPostCard
            title="Step by step guide to create a new component in Angular 5"
          ...
          />
          <BlogPostCard
            title="Concept of placeholders in scss/ sass"
          ...
          />
          <BlogPostCard
            title="Using jquery plugins in Angular 5"
